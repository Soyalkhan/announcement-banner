...
**GitHub Repository:** [https://github.com/Soyalkhan/announcement-banner](https://github.com/Soyalkhan/announcement-banner)
...
```bash
git clone https://github.com/Soyalkhan/announcement-banner.git
...
Make sure MongoDB is running locally or you an connect with you existing Atlas
